...
async def get_wheel_config(
    ...
    # VPN subscription gating removed in boilerplate conversion --
    # the wheel is now available to every authenticated user.
    ...
    # Eligible subscriptions list removed alongside the VPN subscription stack.
...
async def create_stars_invoice(
    ...
    # VPN subscription gating removed in boilerplate conversion --
    # any authenticated user can request a Stars invoice.
