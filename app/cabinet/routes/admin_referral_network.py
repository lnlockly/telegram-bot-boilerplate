...
def _compute_subscription_status(
    ...
    """Subscription model removed; always returns None."""
    return None
...
async def _fetch_subscription_info(
    ...
    """Subscription model removed; returns empty dict stub."""
    return {}
...
async def get_network_user_detail(
    ...
    # Subscription model removed; fetch user only.
    ...
    # Subscription model removed; subscription fields are always empty.
