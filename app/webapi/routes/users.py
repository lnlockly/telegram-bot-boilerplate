...
from app.database.models import PaymentMethod, PromoGroup, User, UserStatus
...
def _serialize_user(user: User) -> UserResponse:
    ...
    return UserResponse(
        ...
        # The VPN subscription stack was removed in the boilerplate
        # conversion; subscription fields are always empty now.
        subscription=None,
        subscriptions=[],
    )
