...
from app.database.models import ContestTemplate, User
...
class ContestRotationService:
    ...
    async def _load_users_batch(self, db: AsyncSession, offset: int, limit: int) -> list[User]:
        ...
        # Subscription-based filtering removed in boilerplate; broadcast to all
        # users in the requested batch.
        # TODO(boilerplate): re-add an eligibility filter for your product.
        return list(users)
