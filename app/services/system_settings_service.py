...
def clear_db_period_prices(*args, **kwargs):
    return None


def refresh_classic_period_prices(*args, **kwargs):
    return None


def refresh_period_prices(*args, **kwargs):
    return None


def refresh_traffic_prices(*args, **kwargs):
    return None
...
class BotConfigurationService:
    ...
    async def set_value(
        ...
        *,
        ...
        # Tariffs mode price loading removed in boilerplate.
