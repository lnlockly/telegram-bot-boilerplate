...
class ContestAttemptService:
    ...
    async def _award_prize(
        ...
        if prize_type == PrizeType.DAYS.value:
            # Subscription extension was the original VPN prize. Subscriptions
            # are no longer modelled in the boilerplate. Surface a generic
            # message instead — adapt to your product if you reintroduce
            # subscription-day prizes.
            # TODO(boilerplate): replace with your own day-based reward.
