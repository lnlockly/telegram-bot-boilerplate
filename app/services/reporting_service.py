...
class ReportingService:
    ...
    async def _collect_current_totals(self, session) -> dict:
        # Subscription stats removed in boilerplate.
    ...
    async def _collect_period_stats(
        ...
        # Subscription/trial/conversion stats removed in boilerplate.
        new_trials = 0
        direct_paid = 0
        trial_to_paid_conversions = 0
        subscription_payments_count = 0
        subscription_payments_amount = 0
    ...
    async def _get_user_usage_stats(self, session) -> dict[str, int]:
        # Subscription-based usage stats removed in boilerplate.
        return {
            'active_paid_users': 0,
            'never_connected_users': 0,
        }
