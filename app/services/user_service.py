...
class UserService:
    ...
    async def get_potential_customers(
        ...
        try:
            ...
            count_query = select(func.count(User.id)).where(*base_filters)
    ...
    async def block_user(
        ...
        try:
            ...
            # Subscription/Remnawave deactivation removed in boilerplate.
    ...
    async def unblock_user(self, db: AsyncSession, user_id: int, admin_id: int) -> bool:
        try:
            ...
            # Subscription/Remnawave restoration removed in boilerplate.
            await db.commit()
    ...
    async def delete_user_account(
        ...
        try:
            ...
            # Subscription/Remnawave panel cleanup removed in boilerplate.
            ...
            # SubscriptionConversion cleanup removed in boilerplate.
            ...
            # Subscription/SubscriptionServer/server_squad cleanup removed in boilerplate.
    ...
    async def cleanup_inactive_users(self, db: AsyncSession, months: int = None) -> tuple[int, int]:
        ...
        try:
            ...
            for user in inactive_users:
                # Subscription check removed in boilerplate.
