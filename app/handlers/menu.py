...
async def get_main_menu_text(user, texts, db: AsyncSession):
    ...
    # Try the legacy template first (with subscription_status placeholder)
    # so existing localizations keep working; fall back to a plain greeting
    # for boilerplate mode.
    try:
