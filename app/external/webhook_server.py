...
class WebhookServer:
    ...
    async def _tribute_webhook_handler(self, request: web.Request) -> web.Response:
        try:
            ...
            logger.info('Signature', signature_present=bool(signature))
    ...
    async def _cryptobot_webhook_handler(self, request: web.Request) -> web.Response:
        try:
            ...
            logger.info('CryptoBot Signature', signature_present=bool(signature))
        ...
        try:
            ...
            async with AsyncSessionLocal() as db:
                ...
                if refund_amount < apple_txn.amount_kopeks:
                    ...
                    # Subscription module deleted -- no active subscriptions to disable.
